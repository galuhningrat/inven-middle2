...
<div class="data-table-container">
    <div class="table-header">
        ...
        <div style="display: flex; gap: 1rem; align-items: center; flex-wrap: wrap;">
            <div class="search-box">
                ...
                <input type="text" class="search-input" id="assetSearch" placeholder="Cari aset..." value="{{ request('search') }}">
            </div>
                ...
                @forelse($assets as $asset)
                    <tr>
                        <td class="col-checkbox">
                            <input type="checkbox" class="asset-checkbox" value="{{ $asset->id }}" onchange="updateSelectedCount()">
                        </td>
                    ...
                    <tr>
                        <td colspan="11" style="text-align: center; padding: 2rem;">
                            <div style="color: var(--text-secondary);">
                                ...
                                <a href="{{ route('assets-inv.create') }}" class="btn btn-primary" style="margin-top: 1rem;">+ Tambah Aset Pertama</a>
                            </div>
                        </td>
                    </tr>
                @endforelse
    ...
    <div style="padding: 1rem 2rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
...
<!-- Easy Touch Button -->
<div class="easy-touch-button" id="easyTouchBtn" style="display: none;">
    <img src="{{ asset('images/logo-stti.png') }}" alt="Quick Menu">
</div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Show easy touch on mobile
        if (window.innerWidth < 1024) {
            document.getElementById('easyTouchBtn').style.display = 'flex';
        }
        ...
        document.addEventListener('click', function(e) {
            if (!easyTouchBtn.contains(e.target) && !easyTouchMenu.contains(e.target)) {
